...
import com.yurkiss.planradar.weatherapp.details.presentation.databinding.WeatherDetailsFragmentBinding
 ...
 */
@AndroidEntryPoint
class CityWeatherFragment : BindingFragment<WeatherDetailsFragmentBinding>(Companion::inflater) {
                    ...
                    when (state) {
                        is CityWeatherScreenState.Loaded -> {
                            binding {
                                ...
                                temperature.text = state.cities.temperature
                                humidity.text = state.cities.humidity
                                windspeed.text = state.cities.windSpeed
