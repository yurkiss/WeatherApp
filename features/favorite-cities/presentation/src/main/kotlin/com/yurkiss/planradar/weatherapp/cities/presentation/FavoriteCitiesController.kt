...
import com.yurkiss.planradar.weatherapp.common.presentation.loadingHolder
import com.yurkiss.planradar.weatherapp.common.presentation.messageHolder
...
class FavoriteCitiesController @AssistedInject constructor(
    ...
    override fun buildModels() {
        viewState.let { state ->
            when (state) {
                is FavoriteCitiesScreenState.Loading -> loadingHolder(labelRepository.getLabel(
                    Labels.LoadingData))
