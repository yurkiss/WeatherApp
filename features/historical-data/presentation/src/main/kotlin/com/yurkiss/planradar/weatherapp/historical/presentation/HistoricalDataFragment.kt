...
import com.yurkiss.planradar.weatherapp.historical_data.presentation.databinding.HistoricalDataFragmentBinding
...
class HistoricalDataFragment : BindingFragment<HistoricalDataFragmentBinding>(::inflater) {
    ...
    override fun setupGUI(binding: HistoricalDataFragmentBinding, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            toolbar.title  = getString(R.string.historical_data_label, name)
        }
